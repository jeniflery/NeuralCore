...
#[derive(Debug)]
pub struct NeuralCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeuralCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeuralCore processing");
    
    let mut processor = NeuralCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeuralCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeuralCoreProcessor::new(false);
